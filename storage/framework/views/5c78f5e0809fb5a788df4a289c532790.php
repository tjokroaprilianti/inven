<div class="modal fade" id="excel_menu" tabindex="-1" aria-labelledby="excel_menu_label" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?php echo e(route('ruangan.import')); ?>" method="POST" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<div class="modal-body">
					<div class="alert alert-info" role="alert">
						<i class="fas fa-info-circle mr-1"></i>
						Untuk melakukan impor excel ruangan. Anda harus unduh template excel dengan klik
						<a href="<?php echo e(asset('import-ruangan-template.xlsx')); ?>" class="alert-link font-weight-bold">
...
<?php /**PATH C:\xampp\htdocs\inven\resources\views/commodity-locations/modal/import.blade.php ENDPATH**/ ?>