		...
		<div class="accordion-body collapse show" id="panel-body-1" data-parent="#filter-accordion">
			<form action="" method="GET">
				...
				<div class="d-flex">
					...
					<a href="<?php echo e($resetFilterURL); ?>" class="btn btn-warning" role="button">
...
<?php /**PATH C:\xampp\htdocs\inven\resources\views/components/filter/index.blade.php ENDPATH**/ ?>