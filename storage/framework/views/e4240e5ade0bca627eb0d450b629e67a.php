...
unset($__errorArgs, $__bag); ?>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="form-control select2 <?php $__errorArgs = ['commodity_location_id', 'store'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="material"
									id="material" value="<?php echo e(old('material')); ?>" placeholder="Masukan bahan barang" required>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="form-control select2 <?php $__errorArgs = ['commodity_acquisition_id', 'store'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH C:\xampp\htdocs\inven\resources\views/commodities/modal/create.blade.php ENDPATH**/ ?>