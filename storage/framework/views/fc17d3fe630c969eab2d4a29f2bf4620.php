			...
			<form action="<?php echo e(route('barang.import')); ?>" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="alert alert-info" role="alert">
						...
						<a href="<?php echo e(asset('import-barang-template.xlsx')); ?>" class="alert-link font-weight-bold">
...
<?php /**PATH C:\xampp\htdocs\inven\resources\views/commodities/modal/import.blade.php ENDPATH**/ ?>