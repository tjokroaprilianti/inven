<script>
	$(document).ready(function () {
		...
		$(".qr-modal-button").on("click", function () {
			...
			let url = "<?php echo e(route('api.barang.generate-qrcode', ':paramID')); ?>".replace(
				":paramID",
				id
			);
...
<?php /**PATH C:\xampp\htdocs\inven\resources\views/commodities/_script.blade.php ENDPATH**/ ?>