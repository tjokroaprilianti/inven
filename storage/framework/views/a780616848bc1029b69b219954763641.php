<div class="modal fade" id="export_menu" tabindex="-1" aria-labelledby="export_menu_label" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?php echo e(route('ruangan.export')); ?>" method="POST">
				<?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\inven\resources\views/commodity-locations/modal/export.blade.php ENDPATH**/ ?>